...
$PasswordProfile.Password = "ESPC2019!@"
...
$Sku2 = New-Object -TypeName Microsoft.Open.AzureAD.Model.AssignedLicense
$Sku2.SkuId = "b05e124f-c7cc-45a0-a6aa-8cf78c946968"
...
New-SPOSite -Url https://globomanticsorg.sharepoint.com/teams/ESPC2019 -Owner vlad@globomantics.org -StorageQuota 1024 -LocaleID 1033 -Template "STS#3" -Title "IT Team Site"


Remove-SPOSite `
    -Identity https://globomanticsorg.sharepoint.com/teams/ESPC2019 `
    -Confirm:$false
	
Get-SPODeletedSite 

Restore-SPODeletedSite -Identity https://globomanticsorg.sharepoint.com/teams/ESPC2019

$site = Get-SPOSite -Identity https://globomanticsorg.sharepoint.com/teams/ESPC2019
...
New-TeamChannel -GroupId $team.groupid -DisplayName "ESPC2019" -MembershipType Private
